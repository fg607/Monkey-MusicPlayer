...
public class SlidingMenu extends ViewGroup {
    ...
    private OnSlidingMenuListener onSlidingMenuListener;//OnSlidingMenuListener是一个open(),close()接口
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        menu.measure(widthMeasureSpec - 250, heightMeasureSpec);//250为留给mainView显示的宽度
    }
